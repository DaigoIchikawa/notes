...
let languageDict = {
  ja:{
    ...
    'Username should be an email.': '正しい形式のメールアドレスを入力してくだ さい',
    ...
    'The following fields must be completed: Username': 'メールアドレスを入力 してください',
    'The following fields must be completed: Username, Password': 'メールアド レスとパスワードを入力してください',
    'The following fields must be completed: Password': 'パスワードを入力して ください',
    "1 validation error detected: Value at 'password' failed to satisfy constraint: Member must have length greater than or equal to 6": 'パスワードは6文字 以上にしてください',
